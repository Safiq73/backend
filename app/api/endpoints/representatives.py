...
async def link_representative_to_user(
    ...
    try:
        ...
        linked_rep = await representative_service.link_user_to_representative(
            user_id, 
            link_request.representative_id
        )
        
        # Get updated user data with representative info
        ...
        return APIResponse(
            ...
            data={
                ...
                "representative": RepresentativeResponse(**linked_rep)
            }
        )
...
async def update_user_representative_link(
    ...
    try:
        ...
        updated_rep = await representative_service.update_user_representative(
            user_id, 
            link_request.representative_id
        )
        ...
        user_data = await user_service.get_user_by_id(user_id)
        if user_data:
            user_data['linked_representative'] = updated_rep
        ...
        return APIResponse(
            ...
            data={
                "user": UserWithRepresentativeResponse(**user_data) if user_data else None,
                "representative": RepresentativeResponse(**updated_rep)
            }
        )
